...
def handle_translation():
    ...
    # this request (words as 1 string) {words: 'Hello, I am a computer programmer',
    #  lang: "fr"} returns translation as one string
    
    # {'translatedText': 'Bonjour, je suis informaticien', 
    # 'detectedSourceLanguage': 'en', 
    # 'input': 'Hello, I am a computer programmer'}

    
# ISSUE HERE IS WITH SHORTER STRINGS DOESN"T ALWAYS DETECT CORRECT LANAGUAGE-see if can specify language to avoid bad translations
#         this request (words in array) {"words": ["Hello", "I am", "computer programmer"],
# "lang": "fr"}
...
#         "detectedSourceLanguage": "en",
#         "input": "I am",
#         "translatedText": "Je suis"
#     },
#     {
#         "detectedSourceLanguage": "da",
#         "input": "computer programmer",
#         "translatedText": "logiciels d&#39;ordinateur"
#     }
# ]
